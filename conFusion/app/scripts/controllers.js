...
angular.module('confusionApp')
    ...
    .controller('IndexController', ['$scope', '$stateParams', 'menuFactory', 'corporateFactory',
        function ($scope, $stateParams, menuFactory, corporateFactory) {
            ...
            for (var key in corporateFactory.getLeaders()) {
                var leader = corporateFactory.getLeader(key);
                if (leader.hasOwnProperty("designation") && leader.designation == "Executive Chef") {
                    $scope.leader = leader;
                }
            }
